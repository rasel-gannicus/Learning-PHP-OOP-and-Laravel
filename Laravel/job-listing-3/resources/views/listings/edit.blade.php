...
<x-layout>
    <div class="mx-auto max-w-[800px]  mb-40">
        <div class="bg-gray-500 border border-gray-200 p-10 rounded max-w-lg mx-auto ">
            <header class="text-center">
                <h2 class="text-2xl font-bold uppercase mb-1">
                    Update a Gig
                </h2>
                <p class="mb-4">Update a gig to find a developer</p>
            </header>
            ...
            <form method="POST" action="/listing/{{$listing->id}}">
                ...
                <div class="mb-6">
                    ...
                    @error('company')
                        <p class="text-red-500 my-5">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
                        placeholder="Include tasks, requirements, salary, etc"> {{$listing->company}}</textarea>
